...
- **images_bat** : This directory stores images specifically related to Lausanne building facades, sourced from Google Street View.
- **dataset** : The dataset directory contains the collected building images utilized in the project's analysis.
- **materials** : File containing additional resources, including images of materials corresponding to the five classes.
- **images_test** : It includes supplementary images used for final testing, serving as illustrative examples.
- **illustrations** : This visual image file enhances the explanations and concepts presented in the project's notebook.
